...
class JiraSyncStatusSection extends StatelessWidget {
  const JiraSyncStatusSection({
    super.key,
    required this.lastSyncAt,
    required this.lastSyncIssueCount,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _StatRow(label: 'Issues Synced', value: '$lastSyncIssueCount'),
          const SizedBox(height: 8),
          _StatRow(label: 'Selected Projects', value: '$selectedProjectCount'),
        ],
      ),
    );
  }
