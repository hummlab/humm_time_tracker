...
Future<void> showWeeklyEntryDialog({
  ...
  DateTime currentEnd =
      existingEntry != null ? currentStart.add(Duration(minutes: existingEntry.durationMinutes)) : end;
  ...
  showGeneralDialog(
    ...
    pageBuilder:
        (context, anim1, anim2) => StatefulBuilder(
                  ...
                  child: Material(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: AppTheme.primaryAccent.withValues(alpha: 0.22)),
                      ),
                      child: Column(
                        ...
                        children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        const Icon(Icons.schedule, size: 14, color: AppTheme.primaryAccent),
                                    ...
                                    TextField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        enabledBorder: OutlineInputBorder(
                                          ...
                                          borderSide: BorderSide(color: AppTheme.borderDark.withValues(alpha: 0.9)),
                                        ),
                                        focusedBorder: OutlineInputBorder(
                                          borderRadius: BorderRadius.circular(10),
                                          borderSide: const BorderSide(color: AppTheme.primaryAccent, width: 1.4),
                                        ),
                                        isDense: true,
                                      ),
                                    ),
                          ...
                          Row(
                            children: [
                              _timeInput(context, currentStart, (newTime) {
                                setDialogState(() {
                              ...
                              _timeInput(context, currentEnd, (newTime) {
                                setDialogState(() {
                                  currentEnd = DateTime(
                                    currentEnd.year,
                                    currentEnd.month,
                                  ...
                                  if (currentEnd.isBefore(currentStart)) {
                                    currentStart = currentEnd.subtract(const Duration(minutes: 15));
                                  }
                                });
                              }),
                              const Spacer(),
                              if (existingEntry != null) ...[
                                OutlinedButton(
                                  ...
                                  style: OutlinedButton.styleFrom(
                                    ...
                                    side: BorderSide(color: AppTheme.tertiaryAccent.withValues(alpha: 0.45)),
  ...
  return Column(
    ...
    children: [
      ...
      PopupMenuButton<String?>(
        ...
        itemBuilder:
            (context) => [
              const PopupMenuItem(value: null, child: Text('No Project', style: TextStyle(fontSize: 12))),
              ...projects.map(
                (p) => PopupMenuItem(
                  value: p.id,
                  child: Row(
                    children: [
                      Container(
                        width: 8,
                        height: 8,
                        decoration: BoxDecoration(color: AppTheme.colorFromHex(p.color), shape: BoxShape.circle),
                      ),
                      const SizedBox(width: 8),
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(color: selectedProject != null ? Colors.white : AppTheme.textMuted, fontSize: 12),
              ),
...
Widget _buildTagSelector(List<Tag> tags, List<String> selectedIds, Function(String) onToggle) {
  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Row(
        children: [
          ...
          const SizedBox(width: 8),
          Text('Tags', style: TextStyle(color: AppTheme.textMuted, fontSize: 12)),
        ],
      ),
            ...
            tags.map((t) {
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: isSelected ? AppTheme.primaryAccent : AppTheme.surfaceDark,
                    borderRadius: BorderRadius.circular(4),
                    border: Border.all(color: isSelected ? Colors.transparent : AppTheme.borderDark),
                  ),
                  child: Text(
                    t.name,
                    style: TextStyle(
...
Widget _timeInput(BuildContext context, DateTime time, Function(TimeOfDay) onTimeSelected) {
  return GestureDetector(
    onTap: () async {
    ...
    child: Container(
      ...
      decoration: BoxDecoration(border: Border.all(color: AppTheme.borderDark), borderRadius: BorderRadius.circular(4)),
      child: Text(DateFormat('HH:mm').format(time), style: const TextStyle(color: Colors.white, fontSize: 12)),
    ),
  );
}
