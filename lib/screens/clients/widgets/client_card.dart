        ...
        child: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.business, size: 24, color: AppTheme.primaryAccent),
            ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Icon(Icons.folder_outlined, size: 14, color: AppTheme.textMuted),
                      const SizedBox(width: 4),
                      Text('$projectCount projects', style: const TextStyle(fontSize: 12, color: AppTheme.textMuted)),
            ...
            IconButton(onPressed: onDelete, icon: const Icon(Icons.delete_outline), color: AppTheme.tertiaryAccent),
          ],
        ),
      ),
    );
