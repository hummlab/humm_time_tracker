...
class LoginCubit extends BaseCubit<LoginState> {
  ...
  Future<void> signIn(String email, String password) async {
    ...
    emit(
      state.copyWith(
        isSubmitting: false,
        errorMessage: ok ? null : (_authDataProvider.error ?? 'Invalid email or password'),
      ),
    );
  }
  ...
  Future<void> signUp(String email, String password) async {
    ...
    emit(
      state.copyWith(
        isSubmitting: false,
        errorMessage: ok ? null : (_authDataProvider.error ?? 'Failed to create account'),
      ),
    );
  }
  ...
  Future<void> sendPasswordReset(String email) async {
    ...
    emit(
      state.copyWith(
        isSubmitting: false,
        errorMessage: ok ? null : (_authDataProvider.error ?? 'Failed to send reset email'),
