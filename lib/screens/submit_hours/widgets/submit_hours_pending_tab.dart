...
class SubmitHoursPendingTab extends StatelessWidget {
  const SubmitHoursPendingTab({
    super.key,
  ...
  Widget build(BuildContext context) {
    if (entryCount == 0) {
      return const SubmitHoursEmptyState(
        ...
        subtitle: 'All submitted entries have been processed.',
    ...
    return Column(
      children: [
        SubmitHoursSummaryBar(
          ...
          mode: SubmitHoursSummaryMode.pending,
