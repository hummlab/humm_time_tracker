...
mixin _$Client {
  ...
  List<String> get linkedEmails => throw _privateConstructorUsedError;
    ...
    return _then(
      _value.copyWith(
            ...
            linkedEmails:
                null == linkedEmails
                    ? _value.linkedEmails
                    : linkedEmails // ignore: cast_nullable_to_non_nullable
                        as List<String>,
          )
          as $Val,
    );
...
class _$ClientImpl extends _Client {
  const _$ClientImpl({
    ...
    final List<String> linkedEmails = const [],
  }) : _linkedEmails = linkedEmails,
       super._();
  ...
  final List<String> _linkedEmails;
  @override
  @JsonKey()
  List<String> get linkedEmails {
    if (_linkedEmails is EqualUnmodifiableListView) return _linkedEmails;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_linkedEmails);
  }

  @override
  String toString() {
    return 'Client(id: $id, name: $name, email: $email, phone: $phone, createdAt: $createdAt, linkedEmails: $linkedEmails)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other._linkedEmails, _linkedEmails));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, email, phone, createdAt, const DeepCollectionEquality().hash(_linkedEmails));
